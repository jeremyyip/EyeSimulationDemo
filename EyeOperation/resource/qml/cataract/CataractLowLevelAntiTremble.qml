...
* @file		CataractLowLevelAntiTremble.qml
* @brief	AntiTremble low level course entrance of cataract
* @version	1.0.0
* @author	Ye ChengYang
...
//course choose rectangle for AntiTremble page
Rectangle{
    id: rect_course_lowlevel_anti_tremble

    width: global_var.window_width
    height: 440

    visible: (global_var.current_cata_level == Enum.ECataLevelChoose.CataLowLevelAntiTremble)? true:false;
    ...
    //button 1
    Rectangle{
        id: antitremblecourse_lowlevel_1
        ...
        MouseArea{
            ...
            onExited: {
                antitremblecourse_lowlevel_1.opacity = 1;
            }
    ...
    //button 2
    Rectangle{
        id: antitremblecourse_lowlevel_2

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_1.right
       ...
       /* Image{
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_2.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_2.opacity = 1;
            }
    ...
    //button 3
    Rectangle{
        id: antitremblecourse_lowlevel_3

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_2.right
        anchors.leftMargin: 80
        anchors.top: parent.top
        anchors.topMargin: 20
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_3.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_3.opacity = 1;
            }
    ...
    //button 4
    Rectangle{
        id: antitremblecourse_lowlevel_4

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_3.right
        anchors.leftMargin: 80
        anchors.top: parent.top
        anchors.topMargin: 20
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_4.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_4.opacity = 1;
            }
    ...
    //button 5
    Rectangle{
        id: antitremblecourse_lowlevel_5

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_1.left
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_5.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_5.opacity = 1;
            }
    ...
    //button 6
    Rectangle{
        id: antitremblecourse_lowlevel_6

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_2.left
        anchors.leftMargin: 0
        anchors.top: antitremblecourse_lowlevel_2.bottom
        anchors.topMargin: 60
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_6.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_6.opacity = 1;
            }
    ...
    //button 7
    Rectangle{
        id: antitremblecourse_lowlevel_7

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_3.left
        anchors.leftMargin: 0
        anchors.top: antitremblecourse_lowlevel_3.bottom
        anchors.topMargin: 60
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_7.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_7.opacity = 1;
            }
    ...
    //button 8
    Rectangle{
        id: antitremblecourse_lowlevel_8

        width: 140
        height: 140

        anchors.left: antitremblecourse_lowlevel_4.left
        anchors.leftMargin: 0
        anchors.top: antitremblecourse_lowlevel_4.bottom
        anchors.topMargin: 60
        ...
        MouseArea{
            ...
            onEntered: {
                antitremblecourse_lowlevel_8.opacity = 0.8;
            }

            onExited: {
                antitremblecourse_lowlevel_8.opacity = 1;
            }
